...
ThemeAbstract* CLIThemeService::getTheme()
{
...
void CLIThemeService::getConsoleRowMaxLengthAndThemeType()
{
    ...
    consoleRowLength = !configService.getValue("consoleRowMaxLength").empty() && std::stoi(configService.getValue("consoleRowMaxLength")) > 0
...
CLIThemeService CLIThemeService::adaptConsoleRowLengthWithMaxItemValueLength(const std::vector<ListItemEntity> &listItems)
{
    getConsoleRowMaxLengthAndThemeType();
...
CLIThemeService CLIThemeService::substractConsoleRowLength(const int substract)
{
    getConsoleRowMaxLengthAndThemeType();
