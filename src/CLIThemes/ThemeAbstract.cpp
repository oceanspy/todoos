...
std::string ThemeAbstract::autoLineBreak(const std::string &value, const int &length, const int leadingSpaces) {
    std::string br = "\n";
...
//    // Remove the last space from each line
//    for (int i = 0; i < lines.size(); i++)
//    {
//        lines[i].pop_back();
//    }
//
//    // Append spaces to each line
//    for (int i = 0; i < lines.size(); i++)
//    {
//        lines[i] = StringHelper::adjustStringLength(lines[i], length);
//    }
...
std::vector<std::string> ThemeAbstract::splitString(const std::string& str) {
