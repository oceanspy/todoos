...
class MockAppInitialization : public AppInitializationInterface
{
  public:
    explicit MockAppInitialization(IOService& ioService, const std::filesystem::path& customSubDir);
