...
bool
MockAppInstallation::isNew()
{
    return !std::filesystem::exists(init.getConfigFilePath());
}

void
MockAppInstallation::make()
{
    ioService.info("First launch detected.");
    ioService.print("MockAppInstallationializing program...");
...
void
MockAppInstallation::createDirectories()
{
...
void
MockAppInstallation::createConfigFile()
{
...
void
MockAppInstallation::createCacheFile()
{
...
void
MockAppInstallation::createListOfListFile()
{
...
void
MockAppInstallation::createListFile(const std::string& listName)
{
...
void
MockAppInstallation::populateNewListFile(std::ofstream& outfile)
{
