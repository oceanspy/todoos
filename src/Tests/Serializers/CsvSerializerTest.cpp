...
TEST_CASE("CsvSerializer tests", "[CsvSerializer]")
{
    ...
    {
        CsvSerializer csvService(ioService);
    ...
    {
        CsvSerializer csvService(ioService);
        std::vector<std::vector<std::string>> testData = { { "John", "He said, \"Hello, World!\"" },
                                                           { "Jane", "She replied, \"Nice to meet you.\"" } };
