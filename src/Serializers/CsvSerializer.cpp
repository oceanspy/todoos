...
CsvSerializer::CsvSerializer(IOService& ioService)
  : ioService(ioService)
{
}

void
CsvSerializer::load(std::filesystem::path path)
{
    this->path = path;
...
bool
CsvSerializer::isFileWritable(std::filesystem::path path)
{
    if (!fileWritable) {
...
CsvSerializer::read(std::optional<int> limitOpt)
{
...
void
CsvSerializer::write(std::vector<std::vector<std::string>> data)
{
...
void
CsvSerializer::append(std::vector<std::vector<std::string>> data)
{
...
std::string
CsvSerializer::createItem(const std::string& str)
{
    std::string item;
...
std::string
CsvSerializer::escapeQuotes(const std::string& str)
{
    std::string item = str;
