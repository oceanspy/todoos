#include "ConfSerializer.h"

ConfSerializer::ConfSerializer(IOService& ioService)
  : ioService(ioService)
{
}

void
ConfSerializer::load(std::filesystem::path path)
{
    this->path = path;
...
bool
ConfSerializer::isFileWritable(std::filesystem::path path)
{
    if (!fileWritable) {
...
ConfSerializer::read(std::optional<int> limitOpt)
{
...
void
ConfSerializer::write(std::vector<std::vector<std::string>> data)
{
...
void
ConfSerializer::append(std::vector<std::vector<std::string>> data)
{
...
std::string
ConfSerializer::createItem(const std::string& str)
{
    std::string item;
...
std::string
ConfSerializer::escapeQuotes(const std::string& str)
{
