...
JsonSerializer::JsonSerializer(IOService& ioService)
  : ioService(ioService)
{
}

void
JsonSerializer::load(std::filesystem::path path)
{
    this->path = path;
...
bool
JsonSerializer::isFileWritable(std::filesystem::path path)
{
    if (!fileWritable) {
...
JsonSerializer::read(std::optional<int> limitOpt)
{
...
void
JsonSerializer::write(std::vector<std::vector<std::string>> data)
{
...
void
JsonSerializer::append(std::vector<std::vector<std::string>> data)
{
...
std::string
JsonSerializer::createItem(const std::string& str)
{
    std::string item;
...
std::string
JsonSerializer::escapeQuotes(const std::string& str)
{
