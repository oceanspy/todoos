...
Config::Config(IOService& ioService, Command& command, CommandService& commandService, ConfigService& configService, ListService& listService)
    : ioService(ioService), command(command), commandService(commandService), configService(configService), listService(listService)
{
