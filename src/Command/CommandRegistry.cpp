 ...
 * the command to the struct in CommandRegistry.h
...
int
CommandRegistry::getCommandId(const std::string& commandName)
{
    auto it = std::find_if(
...
CommandRegistry::getMainCommandNames(bool showOnlyAutocomplete)
{
