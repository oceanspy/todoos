#ifndef TODOOS_APPINITIALIZATION_INTERFACE_H
#define TODOOS_APPINITIALIZATION_INTERFACE_H

#include <filesystem>

class AppInitializationInterface
{
  public:
    virtual ~AppInitializationInterface() = default;
...
#endif // TODOOS_APPINITIALIZATION_INTERFACE_H
