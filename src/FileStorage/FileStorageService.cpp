...
FileStorageService::FileStorageService(IOService& ioService, ConfigService& configService)
        : ioService(ioService), configService(configService)
{
}

void FileStorageService::createNewListFile(const std::string& listName)
{
...
void FileStorageService::removeListFile(const std::string& listName)
{
...
void FileStorageService::moveFileTo(const std::string& oldListName, const std::string& newListName)
{
...
void FileStorageService::populateNewListFile(std::ofstream& outfile)
{
