...
PriorityEntity
PriorityService::find(int priorityId)
{
...
PriorityEntity
PriorityService::getPriorityFromName(const std::string& name)
{
...
PriorityService::getPrioritiesNames()
{
...
std::string
PriorityService::getNamesAsString()
{
...
bool
PriorityService::isIdValid(int priorityId)
{
...
bool
PriorityService::isNameValid(const std::string& priorityName)
{
...
int
PriorityService::getIdFromName(const std::string& priority)
{
    for (const PriorityEntity& priorityEntity : priorities) {
...
std::string
PriorityService::getNameFromId(int priorityId)
{
    for (const PriorityEntity& priorityEntity : priorities) {
        if (*priorityEntity.getId() == priorityId) {
...
bool
PriorityService::isMax(const std::string& priorityName)
{
...
bool
PriorityService::isMin(const std::string& priorityName)
{
    int priorityInt = getIdFromName(priorityName);
    priorityInt--;
    if (isIdValid(priorityInt)) {
