#include "PrependItemAction.h"

PrependItemAction::PrependItemAction(IOService& ioService,
...
void
PrependItemAction::execute(Command& command, ListName& listName)
{
    ...
    try {
        listItemService.prepend(id, listName, StringHelpers::vectorToString(itemValueFromArguments));
