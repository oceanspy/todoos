...
void
ListAction::addList(Command subCommand)
{
...
void
ListAction::removeList(Command subCommand)
{
    std::vector<std::string> arguments = subCommand.getArguments();
...
void
ListAction::renameList(Command subCommand)
{
    std::vector<std::string> arguments = subCommand.getArguments();
...
std::string
ListAction::buildName(const ListEntity& listEntity)
{
...
std::string
ListAction::makeListNameFromArguments(std::vector<std::string>& arguments)
{
    std::string name;
...
std::string
ListAction::removeSpaceFromListName(std::string listName)
{
...
std::string
ListAction::addSpaceToListName(std::string listName)
{
    std::replace(listName.begin(), listName.end(), '_', ' ');
    return listName;
}
